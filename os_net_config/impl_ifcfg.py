...
BACKUP_IFCFG_FILES_PATH = '/var/lib/os-net-config/ifcfg-files/'
...
class IfcfgNetConfig(os_net_config.NetConfig):
    ...
    def backup_ifcfg(self, iface_name, backup_path, force=False):
        ...
        if self._is_os_net_config_managed(ifcfg_file) or force:
            for src in src_files:
                if os.path.exists(src):
